...
const Showcase = () => {
  ...
  const colorTokens = {
    primary: [
      { name: "Primary 100", var: "--brand-primary-100", value: "255 100% 98%" },
      { name: "Primary 200", var: "--brand-primary-200", value: "255 94% 91%" },
      { name: "Primary 300", var: "--brand-primary-300", value: "273 75% 40%" },
      { name: "Primary 400", var: "--brand-primary-400", value: "273 76% 29%" },
      { name: "Primary 500", var: "--brand-primary-500", value: "273 73% 17%" },
    ],
    secondary: [
      { name: "Secondary 100", var: "--brand-secondary-100", value: "350 100% 97%" },
      { name: "Secondary 200", var: "--brand-secondary-200", value: "350 86% 90%" },
      { name: "Secondary 300", var: "--brand-secondary-300", value: "349 90% 70%" },
      { name: "Secondary 400", var: "--brand-secondary-400", value: "346 81% 41%" },
      { name: "Secondary 500", var: "--brand-secondary-500", value: "345 80% 20%" },
    ],
    tertiary: [
      { name: "Tertiary 100", var: "--brand-tertiary-100", value: "312 67% 97%" },
      { name: "Tertiary 200", var: "--brand-tertiary-200", value: "312 100% 88%" },
      { name: "Tertiary 300", var: "--brand-tertiary-300", value: "312 100% 79%" },
      { name: "Tertiary 400", var: "--brand-tertiary-400", value: "312 64% 65%" },
      { name: "Tertiary 500", var: "--brand-tertiary-500", value: "312 52% 38%" },
    ],
    feedback: [
      { name: "Success 300", var: "--feedback-success-300", value: "143 70% 38%" },
      { name: "Warning 300", var: "--feedback-warning-300", value: "45 87% 50%" },
      { name: "Error 300", var: "--feedback-error-300", value: "358 77% 44%" },
      { name: "Info 300", var: "--feedback-info-300", value: "218 82% 49%" },
    ],
    neutral: [
      { name: "Neutral 100", var: "--neutral-100", value: "210 40% 94%" },
      { name: "Neutral 200", var: "--neutral-200", value: "210 26% 59%" },
      { name: "Neutral 300", var: "--neutral-300", value: "210 33% 35%" },
      { name: "Neutral 400", var: "--neutral-400", value: "210 50% 20%" },
      { name: "Neutral 500", var: "--neutral-500", value: "210 77% 9%" },
    ],
  };
